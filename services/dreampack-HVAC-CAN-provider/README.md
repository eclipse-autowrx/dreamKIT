...
- [🎯 Development Scenarios & Workflows](#-development-scenarios--workflows)
  - [📋 Scenario Overview](#-scenario-overview)
  - [🖥️ Scenario 1: Local Development (x86_64)](#️-scenario-1-local-development-x86_64)
  - [💻 Scenario 2: ARM Development (Jetson Orin)](#-scenario-2-arm-development-jetson-orin)
  - [🚀 Scenario 3: Production Deployment (k3s)](#-scenario-3-production-deployment-k3s)
  - [🌐 Scenario 4: Marketplace Release](#-scenario-4-marketplace-release)
- [🛠️ Build Script Reference](#️-build-script-reference)
...
├── requirements.txt                      # Python dependencies for vss.sh
│
├── Design Phase Scripts
├── vss.sh                                # VSS mapping generation script
│
├── Deployment Scripts
├── build.sh                              # Build Docker images
├── start.sh                              # Start service (local/prod)
├── stop.sh                               # Stop service (local/prod)
│
├── Design Input Files (User-Designed)
├── prepare-dbc-file/
│   ├── ModelCAN.dbc                      # INPUT: CAN database (user-provided)
│   ├── mapping/
│   │   ├── vss_4.0/
│   │   │   └── dbc_overlay.vspec         # INPUT: VSS-to-CAN mapping (user-designed)
│   │   │
│   │   ├── Design Output Files (Auto-Generated)
│   │   ├── vss_dbc.json                  # OUTPUT: Runtime VSS-DBC mapping
│   │   └── dbc_default_values.json       # OUTPUT: Default CAN signal values
│   │
│   └── createvcan.sh                     # Virtual CAN setup utility
│
├── Runtime Configuration
├── mapping/                              # VSS mapping files for runtime
│   ├── vss_3.0/                         # VSS 3.x mappings (alternative)
│   └── vss_4.0/                         # VSS 4.x mappings (default)
├── config/
...
└── Kubernetes Deployment
    └── manifests/
        ...
        ├── mirror-remote.yaml            # Remote image mirror job (GHCR)
        ├── deployment.yaml               # k3s deployment
        └── service.yaml                  # k3s service
```
